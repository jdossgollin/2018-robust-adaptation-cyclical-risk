  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item structure of climate signal
      \end{itemize}
      \pause
      To analyze predictions, we assess the \emph{bias} and \emph{variance} of predicted flood occurrence.
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{Bias-Variance-Sketch.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
