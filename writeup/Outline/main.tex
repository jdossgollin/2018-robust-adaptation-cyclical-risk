...
\begin{figure}
  \includegraphics[width=\textwidth]{../../figs/example_stationary_long.pdf}
  \caption{
    A single sequence of streamflow generated by each of two generating functions (columns), each fit to three different fitting models (rows) under a stationary case (\(\gamma=0\)). Shown is a long series \(M=N=150\).\label{fig:stationary-long-eg}
  }
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{../../figs/example_stationary_short.pdf}
  \caption{
    As \cref{fig:stationary-long-eg} except \(N=30\).\label{fig:stationary-short-eg}
  }
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{../../figs/example_trend_long.pdf}
  \caption{
    A single sequence of streamflow generated by each of two generating functions (columns), each fit to three different fitting models (rows) under a trend case. For the ENSO model \(\gamma=0.02\) and for the Markov model \(\gamma_1 = 0.02\) and \(\gamma_2=0\). Shown is a long series \(M=N=150\).\label{fig:trend-long-eg}
  }
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{../../figs/example_trend_short.pdf}
  \caption{
    As \cref{fig:trend-long-eg} except \(N=30\).\label{fig:trend-short-eg}
  }
\end{figure}
