\begin{block}{Experiment Results}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{secular-only-nino3-bias-variance.pdf}
    \caption{
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{lfv-only-nino3-bias-variance.pdf}
    \caption{
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{lfv-secular-nino3-bias-variance.pdf}
    \caption{
