...
In this paper we focus \add{more narrowly on the temporal}\remove{ on the narrower question of how the temporal} structure of climate risk and \add{how} the uncertainty associated with its estimation\remove{,} influence\add{s} the answers to these questions.
...
Public or private sector investments in climate adaptation require not only the design of each potential\remove{structural} instrument, but also selecting between instruments with vastly different operational planning periods.
