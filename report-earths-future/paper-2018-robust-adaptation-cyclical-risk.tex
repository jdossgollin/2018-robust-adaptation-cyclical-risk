...
If more complex methods, such as model chains based on \glspl{gcm} and hydrologic models, are used, the sample size $N$ used in our experiments may be straightforwardly interpreted as a surrogate for the total informational uncertainty in the analysis.
...
The long periods and high amplitudes of the oscillations shown in \cref{fig:observed-lfv} and discussed in \cref{sec:intro-lfv} highlight the importance of adapting not only to secular change but also, simultaneously, to \gls{lfv}.
